...
abstract class AbstractGeneralSelectorBasedActionsBuilder<T> @PublishedApi internal constructor(
    ...
    abstract fun buildActions(selected: symphony.Selected<T>): List<Action0<Unit>>
}