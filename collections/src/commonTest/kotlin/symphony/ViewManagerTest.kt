...
class ViewManagerTest {
    ...
    @Test
    fun should_construct_a_view_manager_from_an_enum() = runTest {
    ...
    @Test
    fun should_be_able_to_select_a_specific_view() = runTest {
        val views = viewsOf<TestView>()
    ...
    @Test
    fun should_be_able_to_use_different_kind_of_views() = runTest {
    ...
    @Test
    fun can_invoke_the_callback_when_selected() = runTest {
